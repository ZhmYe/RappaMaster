...
//	PendingTransactions         chan transaction.Transaction
//	EpochEvent                  chan bool
//	DevTransactionChannel       chan []*transaction.PackedTransaction
...
//}
//
//func NewRappaChannel(config *RappaMasterConfig) *RappaChannel {
//	return &RappaChannel{
//		Config:           config,
...
//		PendingTransactions:         make(chan transaction.Transaction, config.MaxCommitSlotItemPoolSize), // todo,
//		EpochEvent:                  make(chan bool, 1),
//		DevTransactionChannel:       make(chan []*transaction.PackedTransaction, config.MaxCommitSlotItemPoolSize), // todo
