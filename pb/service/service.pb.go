...
type SlotCommitRequest struct {
	...
	Ca           []byte  `protobuf:"bytes,3,opt,name=ca,proto3" json:"ca,omitempty"` // 节点的证书
...
func (x *SlotCommitRequest) GetCa() []byte {
	if x != nil {
		return x.Ca
	}
	return nil
...
var file_service_proto_rawDesc = []byte{
	...
	0x67, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x63, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02,
