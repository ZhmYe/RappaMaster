...
type HeartbeatRequest struct {
	...
	Invalids  map[string]int32  `protobuf:"bytes,3,rep,name=invalids,proto3" json:"invalids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`  // 这个epoch中检测出的有问题的slot
