...
type JustifiedSlot struct {
	...
	// TODO: @SD 这里需要在python代码里先加一个commitment字段上去，可以先不真的算后面具体怎么算还要改，先放一个函数在那compute_commitment,我不记得我有没有放了
...
type HeartbeatRequest struct {
	...
	Finalizes map[string][]byte `protobuf:"bytes,2,rep,name=finalizes,proto3" json:"finalizes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 完成的CommitSlotItem列表
	Invalids  map[string][]byte `protobuf:"bytes,3,rep,name=invalids,proto3" json:"invalids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`   // 这个epoch中检测出的有问题的slot
...
func (x *HeartbeatRequest) GetInvalids() map[string][]byte {
	if x != nil {
		return x.Invalids
	}
	return nil
...
var file_service_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x22, 0xae, 0x03, 0x0a, 0x10, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74,
	...
	,
	...
	0x95, 0x02, 0x0a, 0x0f, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x61, 0x67, 0x65, 0x22, 0xab, 0x01, 0x0a, 0x11, 0x53, 0x6c, 0x6f, 0x74, 0x43, 0x6f, 0x6d, 0x6d,
	...
	,
	...
	0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x32, 0x54, 0x0a, 0x0b, 0x43, 0x6f, 0x6f,
	0x72, 0x64, 0x69, 0x6e, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x45, 0x0a, 0x0a, 0x43, 0x6f, 0x6d, 0x6d,
	0x69, 0x74, 0x53, 0x6c, 0x6f, 0x74, 0x12, 0x1a, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x2e, 0x53, 0x6c, 0x6f, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x53, 0x6c, 0x6f,
	0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32,
	0x93, 0x01, 0x0a, 0x0c, 0x4e, 0x6f, 0x64, 0x65, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72,
	...
	0x63, 0x65, 0x2e, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x08, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65,
	0x12, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x64,
	0x75, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_service_proto_goTypes = []any{
	...
	nil,                        // 9: service.HeartbeatRequest.FinalizesEntry
	nil,                        // 10: service.HeartbeatRequest.InvalidsEntry
	nil,                        // 11: service.HeartbeatResponse.NodeStatusEntry
	nil,                        // 12: service.ScheduleRequest.ScheduleEntry
...
var file_service_proto_depIdxs = []int32{
	...
	9,  // 1: service.HeartbeatRequest.finalizes:type_name -> service.HeartbeatRequest.FinalizesEntry
	10, // 2: service.HeartbeatRequest.invalids:type_name -> service.HeartbeatRequest.InvalidsEntry
	11, // 3: service.HeartbeatResponse.nodeStatus:type_name -> service.HeartbeatResponse.NodeStatusEntry
	3,  // 4: service.HeartbeatResponse.votes:type_name -> service.Vote
	12, // 5: service.ScheduleRequest.schedule:type_name -> service.ScheduleRequest.ScheduleEntry
	13, // 6: service.ScheduleRequest.params:type_name -> google.protobuf.Struct
	6,  // 7: service.Coordinator.CommitSlot:input_type -> service.SlotCommitRequest
	1,  // 8: service.NodeExecutor.Heartbeat:input_type -> service.HeartbeatRequest
	4,  // 9: service.NodeExecutor.Schedule:input_type -> service.ScheduleRequest
	7,  // 10: service.Coordinator.CommitSlot:output_type -> service.SlotCommitResponse
	2,  // 11: service.NodeExecutor.Heartbeat:output_type -> service.HeartbeatResponse
	5,  // 12: service.NodeExecutor.Schedule:output_type -> service.ScheduleResponse
