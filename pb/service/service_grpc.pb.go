...
const (
	...
	RappaExecutor_GetAnalytics_FullMethodName = "/service.RappaExecutor/GetAnalytics"
)
...
type RappaExecutorClient interface {
	...
	GetAnalytics(ctx context.Context, in *AnalyticalRequest, opts ...grpc.CallOption) (*AnalyticalResponse, error)
}
...
func (c *rappaExecutorClient) GetAnalytics(ctx context.Context, in *AnalyticalRequest, opts ...grpc.CallOption) (*AnalyticalResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AnalyticalResponse)
	err := c.cc.Invoke(ctx, RappaExecutor_GetAnalytics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RappaExecutorServer interface {
	...
	// GetAnalytics 从节点获取分析结果
	GetAnalytics(context.Context, *AnalyticalRequest) (*AnalyticalResponse, error)
...
func (UnimplementedRappaExecutorServer) GetAnalytics(context.Context, *AnalyticalRequest) (*AnalyticalResponse, error) {
...
func _RappaExecutor_GetAnalytics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnalyticalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RappaExecutorServer).GetAnalytics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RappaExecutor_GetAnalytics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RappaExecutorServer).GetAnalytics(ctx, req.(*AnalyticalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RappaExecutor_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RappaExecutor_GetAnalytics_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "service.proto",
