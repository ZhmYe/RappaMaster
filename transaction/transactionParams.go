...
//
//	default:
//		e := paradigm.Error(paradigm.RuntimeError, "TaskProcessTransactionParams should be updated from TaskProcessTransaction!!!")
//		panic(e.Error())
//
//	}
//}
...
//	for i := 0; i < n; i++ {
//		callData := p.callDatas[i]
//		keys[i] = utils.StringToBytes32(callData["Hash"].(paradigm.SlotHash))
//		jsonData, _ := json.Marshal(callData)
//		values[i] = sha256.Sum256(jsonData)
